...
cd ~
wget http://silema.hiterp.com/tocGame/instalador.zip
wget http://silema.hiterp.com/tocGame/instalador.sh 
echo sa | sudo -S chmod a+x /home/hit/instalador.sh
...
cd ~
wget -q http://web.hiterp.com/tocGame/instalador.zip -P ~/
